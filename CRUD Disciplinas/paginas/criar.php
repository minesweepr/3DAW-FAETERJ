...
<body>
  ...
  <section class="container">
    <aside class="esquerdo">
      ...
      <nav>
        <ul>
          <li class="select"><i class="fa fa-user-plus" aria-hidden="true"></i><a href="criar.php"> Criar Disciplinas</a></li>
    ...
    <main class="corpo"><div class="conteudo">
        <section>
          <h3><i class="fa fa-info-circle" aria-hidden="true"></i> Criar Disciplinas</h3>
        </section>
        <form action="criar.php" method="POST">
            <label for="nome">
                Nome da Disciplina: <input type="text" name="nome" id="nome">
            </label>
            <label for="sigla">
                Sigla da Disciplina: <input type="text" name="sigla" id="sigla">
            </label>
            <label for="carga">
                Carga Horária: <input type="number" name="carga" id="carga">
            </label>

            <button type="submit" value="Submit">Criar Nova Disciplina</button>
        </form>
        <p><?php echo $msg; ?></p>
      </main>
    </article>
